...
class Detector:
    def __init__(self, device):
        config_file = "/mnt/pixstor/data/grzc7/AOTSam/config/GroundingDINO_SwinT_OGC.py"
        grounding_dino_ckpt = '/mnt/pixstor/data/grzc7/AOTSam/ckpt/groundingdino_swint_ogc.pth'
